...
@section('content')
    <div class="container mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-emerald-600 pb-2 inline-block">Manajemen Mars
            Madrasah Abadiyah</h1>
            ...
            <form action="{{ route('cms.admin.mars_madrasah_abadiyah.store_or_update') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="video_url" id="video_url"
                        ...
                        value="{{ old('video_url', $mars->video_url ?? '') }}"
                        placeholder="Contoh: https://www.youtube.com/watch?v=xxxxxxxx">
                ...
                <div class="mb-6">
                    ...
                    <div id="editor-lirik" style="height: 250px;" class="bg-white border border-gray-300 rounded-b-md">
                        {!! old('lirik', $mars->lirik ?? '') !!}
                    </div>

                    <input type="hidden" name="lirik" id="input-lirik">
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // --- INISIALISASI EDITOR LIRIK ---
                // (Tambahkan blok baru ini di bawah yang lain)
                var quillLirik = new Quill('#editor-lirik', {
                    theme: 'snow',
                    modules: {
                        toolbar: '#toolbar-lirik'
                    },
                    placeholder: 'Tulis lirik mars di sini...',
                });

                var inputLirik = document.getElementById('input-lirik');

                // Sinkronisasi Lirik
                if (quillLirik.root.innerHTML.trim() !== '<p><br></p>') {
                    inputLirik.value = quillLirik.root.innerHTML;
                }

                quillLirik.on('text-change', function () {
                    inputLirik.value = quillLirik.root.innerHTML;
                });
