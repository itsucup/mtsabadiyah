    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('cms.admin.hymne_abadiyah.store_or_update') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="url" name="video_url" id="video_url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('video_url') border-red-500 @enderror" value="{{ old('video_url', $hymne->video_url ?? '') }}" placeholder="Contoh: https://www.youtube.com/watch?v=xxxxxxxxxxx">
            ...
            <div class="mb-6">
                ...
                <textarea name="lirik" id="lirik" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('lirik') border-red-500 @enderror" rows="10">{{ old('lirik', $hymne->lirik ?? '') }}</textarea>
