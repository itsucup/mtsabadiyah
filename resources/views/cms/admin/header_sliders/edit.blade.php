...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('cms.admin.header_sliders.update', $slider) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    @if ($slider->image_url)
                        <img src="{{ $slider->image_url }}" alt="Current Slider Image" class="w-32 h-24 object-cover rounded mb-2">
                    @endif
