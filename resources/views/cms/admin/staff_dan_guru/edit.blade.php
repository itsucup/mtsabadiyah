    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('cms.admin.staff_dan_guru.update', $staffDanGuru->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nama') border-red-500 @enderror" value="{{ old('nama', $staffDanGuru->nama) }}" required>
                @error('nama')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="jabatan" id="jabatan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('jabatan') border-red-500 @enderror" value="{{ old('jabatan', $staffDanGuru->jabatan) }}" required>
                @error('jabatan')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <select name="jenis_kelamin" id="jenis_kelamin" class="block appearance-none w-full bg-white border border-gray-300 text-gray-700 py-2 px-3 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline @error('jenis_kelamin') border-red-500 @enderror" required>
                        ...
                        <option value="Laki-laki" {{ old('jenis_kelamin', $staffDanGuru->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                        <option value="Perempuan" {{ old('jenis_kelamin', $staffDanGuru->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                    </select>
            ...
            <div class="mb-6">
                ...
                <label class="inline-flex items-center">
                    <input type="checkbox" name="status_aktif" id="status_aktif" value="1" class="form-checkbox h-5 w-5 text-emerald-600" {{ old('status_aktif', $staffDanGuru->status_aktif) ? 'checked' : '' }}>
