...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Tambah Program Kelas Baru</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('cms.admin.program_kelas.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
