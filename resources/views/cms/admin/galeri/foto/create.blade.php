...
@section('content')
    <div class="container mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-emerald-600 pb-2 inline-block">Tambah Foto Baru
        </h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('cms.admin.galeri.foto.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Format: JPEG, PNG, JPG, GIF, SVG. Max: 2MB. (Lebih bagus aspek
                        foto 3:2)</p>
                    @error('gambar')
                ...
                <div class="mb-4">
                    ...
                    <select name="kategori_foto_id" id="kategori_foto_id"
                        ...
                        @foreach($kategoriFotos as $kategori)
                            <option value="{{ $kategori->id }}" {{ old('kategori_foto_id') == $kategori->id ? 'selected' : '' }}>
