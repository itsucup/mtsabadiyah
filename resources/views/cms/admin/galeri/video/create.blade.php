...
@section('content')
    <h1 class="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-emerald-600 pb-2 inline-block">Tambah Video Baru</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('cms.admin.galeri.video.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="url" id="video_url" name="video_url" value="{{ old('video_url') }}" placeholder="Contoh: https://www.youtube.com/watch?v=dQw4w9WgXcQ" required
