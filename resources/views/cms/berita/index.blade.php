    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <div class="flex-shrink-0 h-20 w-32 overflow-hidden rounded-md">
                                @if ($berita->header_url)
                                    <img class="h-full w-full object-cover" src="{{ $berita->header_url }}" alt="{{ $berita->judul }}">
                                @else
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <div class="text-sm text-gray-500 mt-1 line-clamp-2">
                                {{ Str::limit(strip_tags($berita->konten), 100) }} {{-- Gunakan Str::limit untuk preview konten --}}
                            </div>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-5 py-5 bg-white text-sm text-center text-gray-500">Tidak ada data berita.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
