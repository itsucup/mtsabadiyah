  ...
  <div class="bg-emerald-700 text-white pt-6 pb-6 px-6 md:px-20 grid grid-cols-1 md:grid-cols-3 gap-10">
    ...
    <div>
      <div class="flex items-center space-x-4 mb-4">
        ...
        />
        <h3 class="text-xl font-bold">{{ $lembagaSettings->nama_lembaga ?? 'MTs Abadiyah' }}</h3>
      </div>
    ...
    <div>
      ...
      <div class="flex space-x-4 text-2xl">
        @if ($lembagaSettings->facebook_url)
          <a href="{{ $lembagaSettings->facebook_url }}" target="_blank" aria-label="Facebook" class="hover:text-gray-300 transition">
            <i class="fab fa-facebook-f"></i>
          </a>
        @endif
        @if ($lembagaSettings->instagram_url)
          <a href="{{ $lembagaSettings->instagram_url }}" target="_blank" aria-label="Instagram" class="hover:text-gray-300 transition">
            <i class="fab fa-instagram"></i>
          </a>
        @endif
        @if ($lembagaSettings->tiktok_url)
          <a href="{{ $lembagaSettings->tiktok_url }}" target="_blank" aria-label="TikTok" class="hover:text-gray-300 transition">
            <i class="fab fa-tiktok"></i>
          </a>
        @endif
        @if ($lembagaSettings->youtube_url)
          <a href="{{ $lembagaSettings->youtube_url }}" target="_blank" aria-label="YouTube" class="hover:text-gray-300 transition">
