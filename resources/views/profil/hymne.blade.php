...
<head>
    ...
    <title>{{ $lembagaSettings->nama_lembaga ?? 'MTs Abadiyah Gabus Pati' }} - Hymne Abadiyah</title>
...
<body class="font-inter pt-20 md:pt-24">
    ...
    <section class="mx-4 md:mx-20 mb-10">
        @if ($hymne)
            ...
            @endif
            <h1 class="pb-2 text-2xl md:text-3xl font-semibold text-gray-800">Lirik Hymne Abadiyah</h1>
            <div class="pb-4">
